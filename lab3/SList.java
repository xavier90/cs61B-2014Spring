...
public class SList {
  ...
  private static void testLab3() {
	  SList l = new SList();
	  l.insertEnd(new Integer(6));
	  l.insertEnd(new Integer(9));
	  l.insertEnd(new Integer(12));
	  System.out.println();
	  System.out.println("This is the list after insertEnd 6, 9, 12: " + l.toString());
	  
	  l.insertFront(new Integer(3));
	  l.insertEnd(new Integer(15));
	  System.out.println("This is the list after insert 3 and 15 : " + l.toString());
  }
}
